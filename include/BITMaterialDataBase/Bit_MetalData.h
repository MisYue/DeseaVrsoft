...
// 硬度
#include "Bit_HardnessInfo.h"

class BITMATERIALDATABASE_API Bit_MetalData
{
public:
	// 空函数
	Bit_MetalData(void);
	...
	Bit_MetalData( Bit_UnitSystem US , string MMId , string MMaterialName
		...
		, double DrawLimitationStrength[2] , Bit_HardnessInfo MHard , double DrawElongation[2] 
	...
	void Set_Initial( const Bit_UnitSystem& US , const string& MMId 
		...
		, const double DrawLimitationStrength[2] , const Bit_HardnessInfo& MHard 
	...
	//初始化设置(值)
	void Set_Initial_Value( const Bit_UnitSystem& US , const string& MMId 
		, const string& MMaterialName , const string& MMaterialClass
		, const double& MMaterialDensity , const double& CompressYieldStrength_0 
		, const double& CompressYieldStrength_1 , const double& DrawYieldStrength_0
		, const double& DrawYieldStrength_1 , const double& CompressLimitationStrength_0
		, const double& CompressLimitationStrength_1 , const double& DrawLimitationStrength_0
		, const double& DrawLimitationStrength_1 , const Bit_HardnessInfo& MHard 
		, const double& DrawElongation_0 , const double& DrawElongation_1
		, const double& DrawSectionShrinkage_0 , const double& DrawSectionShrinkage_1
		, const double& YoungModulus_0 , const double& YoungModulus_1
		, const double& YawTangestModulus_0 , const double& YawTangestModulus_1
		, const double& CompressionModulus_0 , const double& CompressionModulus_1
		, const double& CompressionTangestModulus_0 , const double& CompressionTangestModulus_1
		, const double& PoissonRatio);
	// **********所有数据转换到新的单位制中***********//
	// 三个单位均转换但是不输出
	...
	// 转换单位并输出
	//Bit_MetalData TransitionUS_Input( const Bit_UnitSystem& NewUS );
	...
	// 得到拉伸屈服强度(带应变率)
	inline double Get_DrawYieldStrength_SR(void)const;
	// 得到拉伸屈服强度
	inline double Get_DrawYieldStrength_St(void)const;

	// 得到压缩极限强度(带应变率)
	inline double Get_CompressLimitationStrength_SR(void)const;
	// 得到压缩极限强度
	inline double Get_CompressLimitationStrength_St(void)const;
	...
	//得到硬度
	inline Bit_HardnessInfo Get_MHard(void)const;
