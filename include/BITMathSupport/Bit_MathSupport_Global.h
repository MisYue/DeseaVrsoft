/************************************************************************
	名称：数学计算模块导出dll动态库配置文件 BITMathSupport
	功能：导出dll
	创建人：徐豫新、尹鹏
	创建时间：2015-1-26
	版本：1.0
...
#ifndef BITMATHSUPPORT_GLOBAL_H
#define BITMATHSUPPORT_GLOBAL_H

#ifdef BITMATHSUPPORT_EXPORTS

#define BITMATHSUPPORT_API __declspec(dllexport)
#else
#define BITMATHSUPPORT_API __declspec(dllimport)
#endif
